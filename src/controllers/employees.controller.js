...
export const createEmployee = async (req, res) => {
    ...
    try {
        const [rows] = await pool.query('INSERT INTO employee (name, salary) VALUES (?, ?)', [name, salary]) //aqui ya estamos mandando el query para el insert que corresponde a sql
        res.send({
            id: rows.insertId,
            name,
            salary
